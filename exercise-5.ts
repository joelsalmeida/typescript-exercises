// Without duplicating type structures, modify filterUsers function definition
// so that we can pass only those criteria which are needed, and not the whole User information
// as it is required now according to typing.
